...
<body>
					...
					<div class="">
						...
						<div class="datadiv">
							<select style="width: 100px;" class="js-example-basic-single"
								name="data" id="sido1"></select> <select style="width: 100px;"
								class="js-example-basic-single" name="data" id="gugun1"></select>
							<select style="width: 100px;" class="js-example-basic-single"
								name="data" id="kind"></select>
							<button style="margin-left: 20px;" id="dataBtn">
	...
	<footer id="fh5co-footer" role="contentinfo"
		...
		<div class="container" style="padding-bottom: 0px; height: 130px;">
			<img style="height: 130px;" id="imfindlogo"
	...
	<script
		src="${pageContext.request.contextPath}/resources/if/js/select.js"></script>
	<script
