...
<article id="content" class="cols-d">
    <div>
        ...
        <form id="terms_form" class="f" action="http://localhost:8080/imfind/login">
            ...
            <p>
                <input type="checkbox" id="check_1"  name="" /> 이용 약관에 동의 합니다.<br />
            </p>      
            ...
            <textarea style="font-size:1em;">
				...
				•   수집항목 :
				이름 , 로그인ID , 비밀번호, 휴대전화번호, 이메일 , 생년월일 , 서비스 이용기록 , 접속 로그 , 접속 IP 정보 등
           ...
           <p>
               <input type="checkbox" id="check_2"  name="" /> 개인정보 수집 및 이용 동의 약관에 동의 합니다.<br />
               <input type="button" id="nextBtn"  class="button_big" style="padding:0 14px 14px 14px;height:26px;" value="다음단계로"/>
           </p>
        </form>
    	</div>    
	</article>
