     ...
     $.ajax({
       ...
       success : function(data){
          ...
          complete : function(){ //등록글이 없으면, 페이지네이션이 계산할 tr카운팅수가 없으므로 무조건 수행 해도 상관 없다.
        	  ...
        	  var tfoot ='</tbody><tfoot><tr><th>회원ID</th><th>주문번호</th><th>결제금액</th><th>결제상태</th><th>결제승인시각</th></tr></tfoot>';
        	  $('#output').append( tfoot );
			},
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">결제완료 리스트</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                	<h3 class="card-title">Title: 결제 완료 리스트 수정중 </h3>
				</div>
