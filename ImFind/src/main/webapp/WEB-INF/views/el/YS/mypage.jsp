...
<body>
 ...
 -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><h4> ${kakaoLoginUser}  ${loginUser} </h4></a>
           <button type="button" id="memberModifyBtn" class="btn btn-default btn-block" style="padding-top:6px; width: 50px; height: 50px;"><a href="./modify">수정</a></button></div>
		   <button type="button" id="memberModifyBtn" class="btn btn-default btn-block" style="padding-top:6px; width: 50px; height: 50px;"><a href="./delete">회원탈퇴</a></button></div>
        </div>
      </div>
      ...
      <nav class="mt-2">
        ...
        <li class="nav-header">마이페이지</li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
             <!--  <a href="javascript:memberList()" class="nav-link">  --> 
                 <a href="./admintest" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>회원조회</p>
                </a>
 ...
 <div class="register-login-section spad">
     <div class="row">
          <div class="col-lg-6 offset-lg-3" style="padding-left: 0px; margin-left: 23%; ">
