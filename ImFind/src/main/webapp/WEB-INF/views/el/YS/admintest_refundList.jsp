...
<head>
 ...
 function refundList(){
   ...
   //  var title ='<h1 style="margin-top:0px; margin-left:200px; width:500px;>결제관리</h1>'
     var form ='<thead><tr><th>회원ID</th><th>주문번호</th><th>결제금액</th><th>결제상태</th><th>결제승인시각</th><th></th><th>환불완료날짜</th></tr></thead><tbody>';
     ...
     $.ajax({
       ...
       success : function(data){
          ...
          complete : function(){ //등록글이 없으면, 페이지네이션이 계산할 tr카운팅수가 없으므로 무조건 수행 해도 상관 없다.
        	  ...
        	  var tfoot ='</tbody><tfoot><tr><th>회원ID</th><th>주문번호</th><th>결제금액</th><th>결제상태</th><th>결제승인시각</th><th></th><th>환불완료날짜</th></tr></tfoot>';
        	  $('#output').append( tfoot );
			},
        ...
        <li class="nav-header">관리자 메뉴</li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="javascript:List()" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>회원2</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">환불 완료 거래 리스트</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                	<h3 class="card-title">Title: 환불 완료 거래 조회</h3>
				</div>
