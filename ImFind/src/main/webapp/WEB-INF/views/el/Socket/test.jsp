...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="./resources/el/YH/adminlte/plugins/fontawesome-free/css/all.min.css">
  <!-- Ionicons -->
            ...
            <div class="card card-prirary cardutline direct-chat direct-chat-primary">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <div class="direct-chat-text" id="output">
                    <%
	                    if(vo != null){ 
	                %>
	                   		<%=vo.getLost_Title() %>
              ...
              <div class="card-footer">
                  ...
                  <div class="input-group">
                    <input type="text" id="msg" value="1212" placeholder="Type Message ..." class="form-control">
...
<!-- jQuery -->
<script src="./resources/el/YH/adminlte/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
<script src="./resources/el/YH/adminlte/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
<script src="./resources/el/YH/adminlte/dist/js/adminlte.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="./resources/el/YH/adminlte/dist/js/demo.js"></script>
