                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="${pageContext.request.contextPath}/resources/el/img/product-single/product-1.jpg" alt="">
                                <div class="zoom-icon">
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel">
                                    <div class="pt active" data-imgbigurl="img/product-single/product-1.jpg"><img
                                            src="${pageContext.request.contextPath}/resources/el/img/product-single/product-1.jpg" alt=""></div>
                                    <div class="pt" data-imgbigurl="img/product-single/product-2.jpg"><img
                                            src="${pageContext.request.contextPath}/resources/el/img/product-single/product-2.jpg" alt=""></div>
                                    <div class="pt" data-imgbigurl="img/product-single/product-3.jpg"><img
                                            src="${pageContext.request.contextPath}/resources/el/img/product-single/product-3.jpg" alt=""></div>
                                    <div class="pt" data-imgbigurl="img/product-single/product-3.jpg"><img
                                            src="${pageContext.request.contextPath}/resources/el/img/product-single/product-3.jpg" alt=""></div>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane fade-in active" id="tab-1" role="tabpanel">
                                    <div class="product-content">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <img src="${pageContext.request.contextPath}/resources/el/img/product-single/tab-desc.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="comment-option">
                                            <div class="co-item">
                                                <div class="avatar-pic">
                                                    <img src="${pageContext.request.contextPath}/resources/el/img/product-single/avatar-1.png" alt="">
                                                </div>
                                            ...
                                            <div class="co-item">
                                                <div class="avatar-pic">
                                                    <img src="${pageContext.request.contextPath}/resources/el/img/product-single/avatar-2.png" alt="">
                                                </div>
                                                <div class="avatar-text">
                                                    <div class="at-rating">
                                                        <i class="fa fa-star"></i>
