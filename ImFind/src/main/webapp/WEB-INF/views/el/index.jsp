...
=======
    ...
    <!-- Page Preloder 
>>>>>>> main_dev
>>>>>>> 96195ea1f8b22a976b75788aa82cd88c98919f25
    <div id="preloder">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="${pageContext.request.contextPath}/resources/el/img/banner-1.jpg" alt="">
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="${pageContext.request.contextPath}/resources/el/img/banner-2.jpg" alt="">
                        <div class="inner-text">
                            <h4>Women’s</h4>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="${pageContext.request.contextPath}/resources/el/img/banner-3.jpg" alt="">
                        <div class="inner-text">
                            <h4>Kid’s</h4>
                        </div>
                    </div>
                ...
                <div class="col-lg-8 offset-lg-1">
                    ...
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/el/img/products/women-1.jpg" alt="">
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/el/img/products/women-2.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/el/img/products/women-3.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/el/img/products/women-4.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/el/img/products/man-1.jpg" alt="">
                                <div class="sale">Sale</div>
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/el/img/products/man-2.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/el/img/products/man-3.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/el/img/products/man-4.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="${pageContext.request.contextPath}/resources/el/img/latest-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="${pageContext.request.contextPath}/resources/el/img/latest-2.jpg" alt="">
                        <div class="latest-text">
                            <div class="tag-list">
                                <div class="tag-item">
                                    <i class="fa fa-calendar-o"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="${pageContext.request.contextPath}/resources/el/img/latest-3.jpg" alt="">
                        <div class="latest-text">
                            <div class="tag-list">
                                <div class="tag-item">
                                    <i class="fa fa-calendar-o"></i>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            <div class="sb-icon">
                                <img src="${pageContext.request.contextPath}/resources/el/img/icon-1.png" alt="">
                            </div>
                            <div class="sb-text">
                                <h6>Free Shipping</h6>
                    ...
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            <div class="sb-icon">
                                <img src="${pageContext.request.contextPath}/resources/el/img/icon-2.png" alt="">
                            </div>
                            <div class="sb-text">
