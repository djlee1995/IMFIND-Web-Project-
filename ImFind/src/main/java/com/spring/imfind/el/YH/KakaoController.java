...
public class KakaoController {
	...
	public String getAccessToken(String code) throws Exception{
		...
		final String Parameters = "?grant_type=authorization_code" 
        ...
        System.out.println("카카오 토큰 요청 -> Response Code : " + responseCode);
	...
	public Map<String, Object> getUserInfo(String access_token) throws IOException, ScriptException{
        ...
        int responseCode = con.getResponseCode();
        System.out.println("카카오 user info 요청 -> Response Code : " + responseCode);
