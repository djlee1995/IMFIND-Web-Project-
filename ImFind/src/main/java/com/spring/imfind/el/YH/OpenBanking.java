...
public class OpenBanking {
	...
	public void getToken(String code) throws Exception {
		...
		final String url ="https://testapi.openbanking.or.kr/oauth/2.0/token"
							+ "?code=" + code
							+ "&client_id=1245365a-f9f6-4ad8-b86d-fb42f8a9deb8"
							+ "&client_secret=efa082ac-cad6-41ab-a97d-7e15a5734622"
       ...
       // con.setRequestProperty("Accept-Language", "en-US,en;q=0.5");
        ...
        System.out.println("오픈뱅킹 info 요청 -> Response Code : " + responseCode);
	...
	/*
	 * 2 legged 인증 - 계좌실명조회 api 요청을 위한 토큰 발급을 위한 method
	 * 
	 * response - json
	 * access_token
	 * client_use_code
	...
	public Map<String, String> getAccountInfo(Map<String, String> map, String token) throws IOException, ScriptException{
		...
		String bank_tran_id = "M202111000" + "U" + Integer.toString((int)(Math.random()*1000000000)); //은행거래고유번호
